import { AffectedBy, affectedList, creatures } from '@/constants/cratures'
    ...
    return (
        <div className='frame-rounded'>
            <ul className="grid grid-cols-8 gap-3 border-b border-neutral-800">
                <li />
                {Object.entries(AffectedBy).map(item =>
