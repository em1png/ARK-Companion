import { CanDamage as CanDamageAll, canDamageStructuresList, creatures } from '@/constants/cratures'
    ...
    return (
        <div className='frame-rounded'>
            <ul className="grid grid-cols-7 gap-3 border-b border-neutral-800">
                <li />
                {Object.entries(CanDamageAll).map(item =>
